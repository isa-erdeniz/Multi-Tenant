"""
GarmentCoreTSClient unit testleri — HTTP çağrısı mock'lanır.
"""
...
class GarmentCoreTSClientTests(TestCase):

    def _get_client(self):
        from apps.core.clients.garment_core_ts_client import GarmentCoreTSClient
        return GarmentCoreTSClient()

    # ------------------------------------------------------------------
    # push_garment
    # ------------------------------------------------------------------

    @patch("apps.core.clients.garment_core_ts_client.requests.post")
    ...
    @patch("apps.core.clients.garment_core_ts_client.requests.get")
