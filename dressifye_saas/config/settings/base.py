"""
Dressifye — Temel Django ayarları.
"""
import os
import sys
...
if USE_S3:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="dressifye-saas-media")
...
MEHLR_PROJECT = env.str("MEHLR_PROJECT", default="dressifye_saas")

# packages/dressifye_saas TypeScript API
