"""
Mehlr → garment-core köprüsü testleri.
gerçek HTTP isteği atılmaz; send_to_garment_core mock'lanır.
"""
...
from mehlr.tasks_garment_core import (
...
class PushGarmentToCoreTests(TestCase):
    @patch("mehlr.tasks_garment_core.send_to_garment_core")
...
class GarmentSavedSignalTests(TestCase):
    ...
    @patch("mehlr.tasks_garment_core.push_garment_to_core")
